    ...
    <div>
        <div class="newForm">
            ...
            <div class="text-align-right">
                <button type="submit" :disabled="!saveButtonState.enabled" class="btn btn-success" v-on:click="saveNew()">
    ...
    export default {
        ...
        data() {
            return {
                ...
                saveButtonState: {enabled: true, text: "Save", icon: "save"}
            }
        },
        methods: {
            ...
            saveNew: function() {
                ...
                newTask.due_date = newTask.due_date + ' 00:00:00';
                apiService.sendNewTask(newTask).then(data => {
